...
void Screen_gameplay2::InitGameplay2Screen()
{
	SetCamera();
	finishScreen = 0;
...
void Screen_gameplay2::UpdateGameplay2Screen()
{
...
void Screen_gameplay2::DrawGameplay2Screen()
{
	BeginMode3D(camera);
	PrintModels();
	EndMode3D();
...
void Screen_gameplay2::UnloadGameplay2Screen()
{
	free(models);
}

int Screen_gameplay2::FinishGameplay2Screen()
{
	return finishScreen;
}

void Screen_gameplay2::CheckMove(Vector3 oldPosition)
{
...
void Screen_gameplay2::SetCamera() {
	// Prepare camera
	camera = { 0 };
...
void Screen_gameplay2::CheckIfEndLevelIsReached() {
...
void Screen_gameplay2::PrintModels() {
